  ...
  const handleQueryChange = useCallback(
    (text: string) => {
      ...
      if (!text.trim()) {
        ...
        // clear results for empty query and mark last searched
      ...
      debounceTimer.current = setTimeout(() => {
        (async () => {
          ...
          try {
            ...
            // ignore — search already handles errors
            setLastSearchedQuery(text);
          }
        })();
      }, 400);
    ...
    <ScreenWrapper padX={false}>
      ...
      {selectedVisitor ? (
        <View className="px-6 pb-4 gap-4">
          ...
          {(selectedVisitor as any)?.isOnSite ? (
          ...
          <Button
            ...
            disabled={isCheckinLoading || (selectedVisitor as any)?.isOnSite}
            size="lg"
          >
            {(selectedVisitor as any)?.isOnSite ? 'Already Checked In' : 'Confirm Check-In'}
          </Button>
        </View>
      ) : null}
    </ScreenWrapper>
