      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="py-24 bg-slate-50">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Left: Image */}
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl bg-gradient-to-br from-slate-300 to-slate-200 flex items-center justify-center order-last lg:order-first">
                <div className="text-center text-slate-500 space-y-2">
                  <div className="text-6xl">📈</div>
                  <p className="text-sm mt-4">Dashboard Image: Analytics with live statistics</p>
                </div>
              </div>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            {/* How It Works Image */}
            <div className="relative h-80 rounded-xl overflow-hidden shadow-lg bg-gradient-to-br from-slate-200 to-slate-100 flex items-center justify-center">
              <div className="text-center text-slate-500 space-y-2">
                <div className="text-6xl">🔄</div>
                <p className="text-sm mt-4">Workflow Image: Process flow visualization</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gradient-to-br from-slate-900 to-blue-900 text-white">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {/* Right: Image Placeholder */}
              <div className="relative h-96 rounded-xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center">
                <div className="text-center text-slate-400 space-y-2">
                  <div className="text-6xl">🔐</div>
                  <p className="text-sm mt-4">Security Image: Data protection & shield concept</p>
                </div>
              </div>
            </div>
          </div>
