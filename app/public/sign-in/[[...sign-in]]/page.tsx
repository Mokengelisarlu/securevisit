            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="text-center pt-2">
                <p className="text-slate-400 text-sm font-medium">
                  Pas encore de compte ? <Link href="/setup-tenant" className="text-blue-400 hover:text-blue-300 font-black decoration-2 underline-offset-4 hover:underline transition-all">S'inscrire</Link>
                </p>
              </div>
            </div>
          </div>
